        ...
        with c4:
            ...
            try:
                ...
                try:
                    ...
                    # Create explainer
                    explainer = shap.TreeExplainer(model.named_steps["classifier"])  # or model if no pipeline
                ...
                if health_score >= 80 and prediction == 0:
                    ...
                    st.warning("⚠️ Good health score but elevated risk. Schedule a full checkup.")
